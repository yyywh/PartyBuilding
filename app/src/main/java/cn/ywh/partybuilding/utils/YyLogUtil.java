...
public class YyLogUtil {
    ...
    public static class Builder {
        ...
        public Builder setGlobalTag(String tag) {
            if (!isSpace(tag)) {
                YyLogUtil.sGlobalTag = tag;
                sTagIsSpace = false;
            } else {
                YyLogUtil.sGlobalTag = "";
                sTagIsSpace = true;
            }
            return this;
        }
